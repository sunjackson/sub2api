...
type AdminService interface {
	...
	SetAccountRateLimited(ctx context.Context, id int64, resetAt time.Time) error
...
func (s *adminServiceImpl) SetAccountRateLimited(ctx context.Context, id int64, resetAt time.Time) error {
	return s.accountRepo.SetRateLimited(ctx, id, resetAt)
}
