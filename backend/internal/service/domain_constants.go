...
const (
	...
	AffiliateRegistrationRewardAmountDefault = 0.0   // 0 = 关闭邀请注册奖励
)
...
const (
	...
	SettingKeyAffiliateRegistrationRewardAmount = "affiliate_registration_reward_amount" // 邀请注册成功后给邀请人的余额奖励（0=关闭）
