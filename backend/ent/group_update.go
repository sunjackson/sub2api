...
func (_u *GroupUpdate) SetSecretShieldEnabled(v bool) *GroupUpdate {
	_u.mutation.SetSecretShieldEnabled(v)
	return _u
}

// SetNillableSecretShieldEnabled sets the "secret_shield_enabled" field if the given value is not nil.
func (_u *GroupUpdate) SetNillableSecretShieldEnabled(v *bool) *GroupUpdate {
	if v != nil {
		_u.SetSecretShieldEnabled(*v)
	}
	return _u
}
...
func (_u *GroupUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.SecretShieldEnabled(); ok {
...
// SetSecretShieldEnabled sets the "secret_shield_enabled" field.
func (_u *GroupUpdateOne) SetSecretShieldEnabled(v bool) *GroupUpdateOne {
	_u.mutation.SetSecretShieldEnabled(v)
	return _u
}

// SetNillableSecretShieldEnabled sets the "secret_shield_enabled" field if the given value is not nil.
func (_u *GroupUpdateOne) SetNillableSecretShieldEnabled(v *bool) *GroupUpdateOne {
	if v != nil {
		_u.SetSecretShieldEnabled(*v)
	}
	return _u
