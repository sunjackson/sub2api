...
func init() {
	...
	// groupDescSecretShieldEnabled is the schema descriptor for secret_shield_enabled field.
	groupDescSecretShieldEnabled := groupFields[4].Descriptor()
	// group.DefaultSecretShieldEnabled holds the default value on creation for the secret_shield_enabled field.
	group.DefaultSecretShieldEnabled = groupDescSecretShieldEnabled.Default.(bool)
