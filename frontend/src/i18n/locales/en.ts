  ...
  admin: {
    ...
    affiliates: {
      ...
      records: {
        ...
        redeemRebate: 'Redeem Top-up Rebate',
    ...
    accountQuotaMonitor: {
      title: 'Quota Monitor',
      description: 'Monitor upstream relay balance and quota usage',
      pageDescription: 'Deduplicate accounts by relay Base URL, monitor balances, and skip invalid balance endpoints automatically.',
      backToChannels: 'Back to channel pricing',
      provider: {
        custom: 'Other / auto probe',
      },
      overview: {
        title: 'Account Base URL Overview',
        description: 'Accounts are grouped by Base URL. One relay only needs one balance monitor. The server probes the real balance endpoint before saving, so failed probes are not added.',
        createMissing: 'Probe and fill missing',
        endpointGroups: 'Base URL groups',
        coveredGroups: 'Covered / missing',
        accountsWithEndpoint: 'Accounts with URL',
        customGroups: 'Other / auto probe',
        duplicates: 'Duplicate groups',
        empty: 'No account Base URLs to show',
        customProbeHint: 'Other, probed on save',
        accounts: 'Accounts',
        monitors: 'Monitors',
        duplicateHint: '{count} extra',
        covered: 'Covered',
        createOne: 'Probe create',
        createSuccess: 'Monitor created after real balance endpoint validation',
        ...
        noSampleAccounts: 'No sample accounts',
      },
    },
    ...
    accounts: {
      ...
      bulkDeleteFilteredConfirm: 'No accounts are selected. Delete the {count} account(s) matching the current filters? This action cannot be undone.',
      ...
      quotaMonitor: {
        ...
        providerOther: 'Other / auto probe',
        supportedHint: 'When enabled, the server verifies the real balance endpoint with the saved account key before creating a monitor. Secrets are never returned to the frontend.',
        unsupportedHint: 'Enter a Base URL first. Other domains use generic balance endpoint probing; failed probes are not added to monitoring.',
    ...
    ops: {
      ...
      alertRules: {
        ...
        metricDescriptions: {
          ...
          memory: 'Current instance memory pressure (0-100, Total - MemAvailable basis).',
      ...
      tooltips: {
        ...
        memory: 'Memory pressure uses Total - MemAvailable. Linux page cache/reclaimable cache is shown separately; high cache does not mean a leak.',
